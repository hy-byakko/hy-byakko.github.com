...
define(['jquery', 'underscore', 'backbone', 'collections/posts', 'views/index', 'views/main', 'views/loading', 'text!templates/tag-link.html', 'text!templates/post-title.html'], function($, _, Backbone, posts, Index, Main, Loading, tagLink, postTitle) {
  'use strict';
